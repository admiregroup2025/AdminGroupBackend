...
adminRoute.post('/admin-register',AdminRegister)  //working
adminRoute.post('/add-user', auth, authorizeAdmin, AdminUserCreate);  // admin
...
//Blog Section     
adminRoute.post('/blog', auth, uploadMedia.single('cover_image'), postBlog);
adminRoute.get('/blog', auth, getBlog);
adminRoute.get('/blog/:blogId', auth, getSingleBlog);
adminRoute.patch('/blog/:blogId', auth, uploadMedia.single('cover_image'), updateBlog);
